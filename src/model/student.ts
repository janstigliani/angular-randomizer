export class Student {
    ...
    constructor(name: string, surname: string, yob:number, gender:string, nationality:string, avatar = "./assets/avatar1.jpeg", marks:number[] = []) {
        this.name = name;
    ...
    */
     ...
     */
    compareByName(student2:Student) {
